...
var loadHTML = function (app) { return __awaiter(void 0, void 0, void 0, function () {
    var container, entry, dom, _a, template, getExternalScripts, getExternalStyleSheets, jsCode;
...
var runJS = function (value, app) {
    ...
    value = value.replace(/__webpack_require__.p = "\/"/, "__webpack_require__.p = \"" + app.entry + "/\";console.log(__webpack_require__.p)");
    console.log(value);
    app.proxy.active();
